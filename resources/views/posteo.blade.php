      ...
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          <div class="post-heading">
            <h1>Detectan un Planeta del Tamaño de la Tierra en la Zona Habitable</h1>
            <h2 class="subheading">Un equipo de científicos transatlánticos, utilizando datos reanalizados del telescopio espacial Kepler de la NASA.</h2>
...
<p>Kepler-1649c orbita su pequeña estrella enana roja tan de cerca que un año en Kepler-1649c equivale a solo 19,5 días terrestres. El sistema tiene otro planeta rocoso de aproximadamente el mismo tamaño, pero orbita la estrella a aproximadamente la mitad de la distancia de Kepler-1649c, similar a cómo Venus orbita nuestro Sol a aproximadamente la mitad de la distancia que la Tierra. Las estrellas enanas rojas se encuentran entre las más comunes en la galaxia, lo que significa que planetas como este podrían ser más comunes de lo que pensábamos anteriormente.
</p>
        </div>
      </div>
    </div>
